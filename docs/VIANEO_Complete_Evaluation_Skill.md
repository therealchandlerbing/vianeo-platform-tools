...
- 🔴 **Critical**: Fundamental (4) + Not satisfied (1)
- 🟠 **High**: Important (3-4) + Rather not satisfied (1-2)
- 🟡 **Medium**: Secondary (2) + Not satisfied (1-2)
- 🟢 **Low**: Any need + Well satisfied (3-4)
...
- [ ] Problem statement is solution-neutral
- [ ] Users ≠ Buyers where applicable
- [ ] Evidence gaps explicitly noted

**Step 2:**
- [ ] All 40 questions scored 1-5
- [ ] Evidence cited for every score ≥3
...
- [ ] Weighted overall score uses formula: (L×0.15)+(D×0.25)+(A×0.20)+(F×0.20)+(V×0.20)
...
**Fixes:**
1. Remove solution: "Need a mobile app" → remove
2. Add measurability: "for healthcare scheduling" → "to reduce appointment no-shows by 30%"
...
- 100% evidence citation for scores ≥3
