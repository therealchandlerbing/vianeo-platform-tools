# 360 SIS Application: [Project Name]
...
[Provide concise overview: (1) Problem, (2) Solution approach, (3) Who benefits]
...
[Describe specific problem or need. Who is affected? Scale? Current inadequacies? Validation evidence?]

**Sentence Count:** [___/3-5]
**Character Count:** [___/750]

**Quality Check:**
- [ ] Solution-neutral (no product/technology mention)
...
[Explain approach to addressing problem. How it works? Innovation or differentiation? Connection to problem? Technology/approach validation?]
...
- [ ] Approach explained (not just features)
- [ ] Within 3-5 sentences
...
[Explain stage selection citing specific evidence from traction, product development, customer validation]
...
[Describe who directly benefits. Demographics? Geography? Scale? Why this population? Current vs. projected reach?]
...
[Describe indirect beneficiaries - those who benefit but don't directly use solution]
...
[Quantify total market opportunity and addressable portion. TAM? SAM? Initial target? Sizing methodology? Growth projections?]
...
[Describe customer discovery: interviews, surveys, user testing. Quantify everything. Key insights? Validation of problem and solution? Pivots/iterations?]
...
[Current product status: stage, features, performance. Development roadmap for next 12 months?]
...
**Key Product Metric:** [Define your most important product metric]

**Growth Rate:** [% MoM or QoQ for key metrics]

**Quality Check:**
- [ ] All cells filled with numbers or "N/A"
- [ ] Trend shows progress
- [ ] Targets are ambitious but realistic
- [ ] Key product metric defined

---

### 3.4 Partnerships and Commitments (3-5 sentences)

[Key partnerships, MOUs, LOIs, commitments. Partner names and types? Commitment level? Value to business model? Timeline?]

**Sentence Count:** [___/3-5]

**Quality Check:**
- [ ] Partner names provided
...
[How money flows? Pricing strategy and tiers? Unit economics (LTV, CAC, margin)? Path to profitability timeline?]

**Sentence Count:** [___/3-5]

**Quality Check:**
- [ ] Pricing specific with tiers
...
[Major cost categories? Current monthly burn rate? Planned changes with growth? Cost efficiencies or economies of scale?]
...
[How is social/environmental impact measured? Primary impact metrics aligned with Theory of Change? Measurement methodology? Current impact quantified? Projected impact at scale?]
...
- **Name:** [Full name]
- **Role/Title:** [Position]
- **Background (3-5 sentences):** [Relevant experience, domain expertise, previous ventures, education]
...
[List 1-3 critical missing roles or capabilities. Include hiring plan and timeline.]
...
**Quality Check:**
- [ ] Advisors provide clear value
- [ ] Engagement level is realistic
- [ ] Expertise relevant to current stage
...
[Risk description and mitigation strategy - especially for healthcare, finance, education]
...
[Explain specifically why applying to this program and what you hope to gain]

**Sentence Count:** [___/3-5]

**Quality Check:**
- [ ] Specific program elements that match needs
- [ ] Current stage and how program accelerates
...
[Be specific about milestones to achieve during program participation]
...
- [ ] Stage selection matches evidence
- [ ] TRL rating consistent
...
- [ ] Ready for evaluation committee
...
**Save as:**
- Markdown: `[ProjectName]_[YYYY-MM-DD]_01_360SIS.md`
- DOCX: `[ProjectName]_[YYYY-MM-DD]_01_360SIS.docx`

**Example:**
- `HealthTech_2025-01-15_01_360SIS.md`
- `HealthTech_2025-01-15_01_360SIS.docx`

---

## NEXT STEPS

After completing 360 SIS Application:

1. **Quality review** - Check all limits and completeness
2. **Consistency check** - Verify alignment with Executive Brief (Step 0)
